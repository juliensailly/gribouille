...
public class Ligne {
    ...
    public Ligne(int qte, Produit produit) {
        ...
        totalHT = Bindings.multiply(this.qte, Bindings.selectFloat(this.produitProperty(), "prix"));
        totalTTC = Bindings.multiply(totalHT, Bindings.selectFloat(this.produitProperty(), "tva"));
    }
