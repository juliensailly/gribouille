...
public class GrilleModel {
	...
	public StringProperty getCase(int lg, int col) {
		return contenu[lg][col];
	}
	...
	public boolean estGagne(String joueur) {
		return gagneLigne(joueur, 0) || gagneLigne(joueur, 1) || gagneLigne(joueur, 2) || gagneColonne(joueur, 0)
				|| gagneColonne(joueur, 1) || gagneColonne(joueur, 2) || gagneDiago1(joueur) || gagneDiago2(joueur);
	}
